import type { TrackMapErrorCode } from '../../../shared/trackMapValidation.js';
...
export function normalizeVehicleSelection(
  ...
  // Older deployed clients sent `sedan`; normalize it so cached pages still join the car branch.
